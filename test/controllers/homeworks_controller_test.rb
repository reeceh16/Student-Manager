...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { description: @homework.description, due_date: @homework.due_date, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { description: @homework.description, due_date: @homework.due_date, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
